<!-- Footer -->
  <footer class="bg-gray-900 text-white pt-12 pb-6">
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        <div>
          <div class="flex items-center space-x-2 mb-4">
            ...
            <span class="text-xl font-bold text-indigo-400">Lumière</span>
          </div>
          <p class="text-gray-400 mb-4">
            Premium e-commerce platform offering the best products at competitive
            prices.
          </p>
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-400">
            <li class="flex items-start">
              ...
              <span>123 Company Street, Lagos, Nigeria</span>
            </li>
            <li class="flex items-center">
              <i class="fas fa-phone-alt mr-2"></i>
              <span>+234 813 4567 890</span>
            </li>
            <li class="flex items-center">
              <i class="fas fa-envelope mr-2"></i>
              <span>support@Lumière.com</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      >
        <p class="text-gray-400 mb-4 md:mb-0">© 2025 Etuka Nkechi Amanda. All rights reserved.</p>
